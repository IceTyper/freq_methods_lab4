...
param_combinations = [
    ...
    {'case': 'd_influence',  'c': 1.5, 'd': 5.3, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Влияние d, Околорезонансная помеха'},
    {'case': 'd_influence',  'c': 1.5, 'd': 8.0, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Влияние d, Далёкая помеха'},

    # --- 2. Исследование влияния амплитуды помехи c при неидеальной настройке фильтра (d = 5.3) ---
    {'case': 'c_influence',  'c': 1.5, 'd': 5.3, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Влияние c, Умеренная смещённая помеха'},
    {'case': 'c_influence',  'c': 5.0, 'd': 5.3, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Влияние c, Мощная смещённая помеха)'},
]
