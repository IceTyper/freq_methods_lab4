...
param_combinations = [
    ...
    {'case_name': 'b1_influence', 'd': 5.0, 'omega_0': 5.0, 'b1': 0.3, 'title': 'Узкая полоса'},
    {'case_name': 'b1_influence', 'd': 5.0, 'omega_0': 5.0, 'b1': 5.0, 'title': 'Широкая полоса'},
    
    # --- 2. Исследование влияния частоты помехи d (при фиксированном b1 = 0.5) ---
    {'case_name': 'd_influence', 'd': 5.3, 'omega_0': 5.0, 'b1': 0.5, 'title': 'Околорезонансная помеха'},
    {'case_name': 'd_influence', 'd': 8.0, 'omega_0': 5.0, 'b1': 0.5, 'title': 'Далёкая помеха'},
]
