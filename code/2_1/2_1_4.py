...
param_combinations = [
    ...
    {'case': 'b1_influence', 'c': 1.5, 'd': 5.0, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Удачная фильтрация (узкий фильтр)'},
    {'case': 'b1_influence', 'c': 1.5, 'd': 5.0, 'omega_0': 5.0, 'b1': 10.0, 'title': 'Неудачная фильтрация (широкий фильтр)'},
    
    # 2. Влияние d (частота помехи) при b1 = 0.5, c = 1.5
    {'case': 'd_influence',  'c': 1.5, 'd': 5.0, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Удачная фильтрация (d = ω₀)'},
    {'case': 'd_influence',  'c': 1.5, 'd': 7.0, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Неудачная фильтрация (d ≠ ω₀)'},

    # 3. Влияние c (амплитуда помехи) при d = omega_0, b1 = 0.5
    {'case': 'c_influence',  'c': 1.5, 'd': 5.0, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Удачная фильтрация (малая помеха)'},
    {'case': 'c_influence',  'c': 4.0, 'd': 5.0, 'omega_0': 5.0, 'b1': 0.5,  'title': 'Неудачная фильтрация (сильная помеха)'},
]
