...
param_combinations = [
    ...
    {'b': 0,   'c': 1.0, 'd': 0.5},    # Только низкочастотная помеха
    {'b': 0,   'c': 1.0, 'd': 10},     # Только высокочастотная помеха
    {'b': 0.5, 'c': 1.0, 'd': 0.5},    # Слабый белый шум + НЧ помеха
    {'b': 0.5, 'c': 1.0, 'd': 10},     # Слабый белый шум + ВЧ помеха
]
...
def create_and_save_plot(filename, data):
    ...
    save_dir = r"C:\Users\fmusa\ITMOStudies\freq_methods\freq_methods_lab4\images\1_4_5"
